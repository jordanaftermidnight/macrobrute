...
/* Dark mode: SVGs were authored against a light cream background, so
   wires drawn in #1a1a1a / #333 / #222 / #444 vanish into the dark
   container background (#2d333b). Re-stroke any near-black line/path/
   polygon to a medium light grey in dark mode only. Light mode is
   unaffected. Stops short of #555 so component fills (e.g. Pico body
   #1a1a1a) keep their dark interior — only the strokes change. */
body:not(.light-mode) .svg-container .wire,
body:not(.light-mode) .svg-container .wire-thick,
body:not(.light-mode) .svg-container .component,
body:not(.light-mode) .svg-container [stroke="#1a1a1a"],
body:not(.light-mode) .svg-container [stroke="#222"],
body:not(.light-mode) .svg-container [stroke="#333"],
body:not(.light-mode) .svg-container [stroke="#444"],
body:not(.light-mode) .svg-container [stroke="black"]
{ stroke: #b0b8c1 !important; }
/* Same idea for fills on small markers/polygons that represent wire
   ends (junction dots, zener arrows, ground bars drawn as filled
   polygons). Without this, those tiny markers vanish too. */
body:not(.light-mode) .svg-container .filled,
body:not(.light-mode) .svg-container polygon[fill="#1a1a1a"],
body:not(.light-mode) .svg-container polygon[fill="#333"]
