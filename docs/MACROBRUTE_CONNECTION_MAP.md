...
## 3. DB-9 B — Inputs + Power (Expander → MicroBrute)

| Pin | Signal | MB Destination | Protection | Series R | Wire Color |
|-----|--------|----------------|------------|----------|------------|
| 1 | Filter CV In | Summing node (U8A) | BAT54S clamp | 220kΩ | White |
| 2 | VCA CV In | TP10/TP11 | BAT54S clamp | 100kΩ | Yellow |
| 3 | Resonance CV In | Vactrol LED | 1kΩ current limit | 1kΩ via 2N3904 | Orange |
| 4 | Sync In | VCO sync point | — | Direct | Green |
| 5 | Gate In | Gate circuit | 1N4148 | — | Blue |
| 6 | Ext Audio In | Mixer ext input | — | Attenuated | Purple |
| 7 | +12V | Breakout PCB | 1N5817 + ferrite | — | Red |
| 8 | -12V | Breakout PCB | 1N5817 + ferrite | — | Brown/stripe |
| 9 | GND | Star ground point | — | — | Black |
